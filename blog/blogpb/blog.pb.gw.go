...
var (
	filter_BlogService_ReadAllBlog_0 = &utilities.DoubleArray{Encoding: map[string]int{"search": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	pattern_BlogService_ReadAllBlog_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "example", "echo", "search"}, "", runtime.AssumeColonVerbOpt(true)))
)
